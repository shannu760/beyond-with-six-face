          ...
          <div className="lg:w-5/12 flex flex-col reveal">
            ...
            <div className="space-y-8 mt-auto">
              <div>
                ...
                <a href="mailto:krishna.addanki633@gmail.com" className="text-olive-dark font-medium text-lg hover:text-gold transition-colors flex items-center gap-3">
              ...
              <div>
                ...
                <div className="flex flex-col gap-4">
                  ...
                  <a href="https://www.instagram.com/shanmukha_krishna_03/" target="_blank" rel="noopener noreferrer" className="text-olive-dark/70 font-medium hover:text-gold transition-colors flex items-center gap-3 text-sm">
                    <Instagram className="w-4 h-4" />
                    shanmukha_krishna_03 (Personal)
                  </a>
            ...
            <form className="flex flex-col gap-8" onSubmit={(e) => e.preventDefault()}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div className="flex flex-col md:col-span-1">
                  ...
                  >
                    <option value="" disabled>Select...</option>
                    <option value="tier1">&lt; $5k</option>
                    <option value="tier2">$5k - $15k</option>
                    <option value="tier3">$15k - $30k</option>
                    <option value="tier4">$30k+</option>
                  </select>
                </div>
                <div className="flex flex-col md:col-span-1">
              ...
              <div className="pt-4">
                <button 
                  type="submit"
                  className="w-full md:w-auto btn-primary bg-olive-dark text-cream hover:bg-gold hover:text-olive-black px-10 py-4 rounded-full text-sm font-bold tracking-wider uppercase transition-all duration-500 shadow-lg hover:shadow-xl hover:-translate-y-1"
                >
                  START A PROJECT →
                </button>
              </div>
