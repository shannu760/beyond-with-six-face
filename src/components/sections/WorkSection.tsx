...
const projects: Project[] = [
  ...
  },
  {
    ...
    name: 'GOD EDITZ',
    category: 'PERSONAL PROJECT',
    description: 'Cinematic video editing and visual storytelling channel exploring the art of digital creation.',
    longDescription: 'A dedicated content platform exploring high-octane video editing, pacing, color science, and visual effects. Merges technical editing precision with atmospheric narrative pacing.',
    tech: ['Premiere Pro', 'After Effects', 'DaVinci Resolve', 'Sound Design'],
    link: 'https://youtube.com/@godeditz08',
    highlights: ['Cinematic Pacing & Rhythms', 'Color Grading Pipelines', 'Visual Effects & Compositing']
  },
  {
    id: '03',
