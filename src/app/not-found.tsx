...
export default function NotFound() {
  return (
    <main className="relative min-h-[100svh] w-full bg-black overflow-x-hidden font-['Geist_Mono:SemiBold'] select-none">
      ...
      {/* 2. Header Logo — centered horizontally at top */}
      <header
        aria-label="LGPSM"
        className="absolute top-[32px] sm:top-[80px] left-1/2 -translate-x-1/2 z-10 flex items-center justify-center origin-top scale-75 sm:scale-100 transition-transform pointer-events-none"
      >
        <div className="w-[233px] h-[40px] flex items-center justify-center">
          ...
          <svg
            ...
            fill="none"
            className="w-[164.311px] h-[40px] flex-shrink-0 ml-[14px]"
            aria-hidden="true"
          >
            <path
