          ...
          <div className="reveal reveal-delay-3 flex-1 bg-olive-dark border border-gold/20 rounded-2xl p-6 flex flex-col justify-center relative overflow-hidden group">
            ...
            <div className="relative z-10 flex flex-col h-full justify-center">
              ...
              <a 
                ...
                className="btn-primary-light bg-cream text-olive-dark hover:bg-gold hover:text-olive-black px-5 py-3 rounded-full text-sm font-medium tracking-wide inline-flex items-center justify-center transition-all duration-500 mt-auto"
              >
                START A PROJECT →
              </a>
            </div>
